...
public class Notif {
    private static final String CHANNEL_ID = "szonyeg_notification_channel";
    ...
    private void createChannel() {
        ...
        NotificationChannel channel = new NotificationChannel
                (CHANNEL_ID, "Szonyeg Notification", NotificationManager.IMPORTANCE_HIGH);
    ...
    public void send(String message) {
        Intent intent = new Intent(mContext, SzonyegekActivity.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, CHANNEL_ID)
                .setContentTitle("Szonyeg Application")
